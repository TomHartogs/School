...
QT_MOC_LITERAL(1, 4, 12), // "valueChanged"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12) // "timerElapsed"

    },
    "Led\0valueChanged\0\0timerElapsed"
};
...
void Led::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Led::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Led::valueChanged)) {
                *result = 0;
            }
        }
    }
