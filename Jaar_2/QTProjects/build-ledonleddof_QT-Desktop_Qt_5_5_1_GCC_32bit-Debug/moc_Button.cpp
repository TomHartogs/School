...
#include "../ledonleddof_QT/Button.h"
...
QT_MOC_LITERAL(3, 22, 7), // "Button&"
QT_MOC_LITERAL(4, 30, 12) // "timerElapsed"

    },
    "Button\0buttonpressed\0\0Button&\0"
    "timerElapsed"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Button::buttonpressed)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Button::buttonpressed(Button & _t1)
{
